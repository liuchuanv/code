...
<script src="/code/tp/Public/assets/js/verificationNumbers.js"></script>
<script src="/code/tp/Public/assets/js/Particleground.js"></script>
<script>
...
<body>
    <dl class="admin_login">
        <form action="<?php echo U('Login/loginHandle');?>" method="post">
            <dt>
