     ...
     <section>
         ...
         <table class="table">
             ...
             <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                 ...
                 <td>
                     <?php if(is_array($vo["Role"])): $i = 0; $__LIST__ = $vo["Role"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rvo): $mod = ($i % 2 );++$i;?>【<?php echo ($rvo["name"]); ?>】<?php endforeach; endif; else: echo "" ;endif; ?>
                 </td>
                 <td><?php if(empty($vo["status"])): ?><span class="c-red">未开启</span><?php else: ?><span class="c-green">开启</span><?php endif; ?></td>
                 ...
                 <td>
                     <a href="/tp/index.php/Admin/Rbac/addUser?id=<?php echo ($vo["id"]); ?>">编辑</a>
                     <a href="/tp/index.php/Admin/Rbac/resumeUserHandler?id=<?php echo ($vo["id"]); ?>"><?php if(empty($vo["status"])): ?><span class="c-red">开启</span><?php else: ?>锁定<?php endif; ?></a>
                     <a href="/tp/index.php/Admin/Rbac/deleteUserHandler?id=<?php echo ($vo["id"]); ?>">删除</a>
                 </td>
